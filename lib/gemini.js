...
function buildLocaleInstruction(locale) {
  ...
  if (norm === 'en') {
    return `LANGUAGE OF OUTPUT (hard rule): write every human-visible string in the JSON in ENGLISH — "impression", "points_forts" items, "a_travailler" items, "espace", "dynamique", "potentiel", "mood". Keep the JSON keys UNCHANGED (they are code identifiers). The "contient_chant" value must stay a strict "true" / "false" string.
...
8. INTERDIT de simuler une relation humaine. PAS de "merci beaucoup", "content de t entendre", "je l ai ecoute plusieurs fois", "j adore", "ravi de", "ca me fait plaisir", ni aucune marque d emotion personnelle ou de familiarite feinte. L utilisateur sait qu il parle a une IA. Reste un 9. FORMAT STRICT de l ouverture de "impression": la PREMIERE phrase DOIT commencer par un groupe nominal qui designe le morceau ou un de ses elements. Debuts autorises: "Le mix...", "L ambiance...", "La production...", "Le morceau...", "Les voix...", "Le groove...", "L arrangement...", "Cette prod...", etc. DEBUTS INTERDITS: "Salut", "Salut l artiste", "Hey", "Yo", "Alors", "Ok", "Je", "J ai", "Tu", "On", ni aucun verbe a la premiere personne.
