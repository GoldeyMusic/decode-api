...
async function analyzeListening(fileBuffer, mimeType, title, artist, mode, vocalType) {
  const prompt = buildPrompt(mode, title || 'ce morceau', vocalType || 'vocal');
