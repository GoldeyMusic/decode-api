...
↳ Cite ces valeurs textuellement dans tes "why"/"summary"/"how" quand elles eclairent un point. En MASTER, calibre sur LUFS/LRA/TruePeak.${hasStems ? ' En VOIX, calibre sur le delta voix/instru et les sibilantes mesurees.' : ''}${hasStereo ? ' En SPATIAL, calibre sur correlation L/R et mono compat.' : ''} N invente AUCUNE autre mesure.` : ''}
